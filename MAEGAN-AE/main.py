...
def main(opt):
    ...
    if opt.dataset == "ugr16":
        ...
        maegan = MAEGAN(opt, input_dim = x_train.shape[1], maxAE=10, minAE=10, filepath=filepath, batch_size=4)
        ...
        maegan = MAEGAN(opt, input_dim = x_train.shape[1], maxAE=10, minAE=3, filepath=filepath, batch_size=8)
