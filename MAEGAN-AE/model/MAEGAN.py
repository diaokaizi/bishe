...
class MAEGAN:
    ...
    def train(self, data):
        ...
        self.autoencoder = Autoencoder(input_dim=self.gan_input_dim, hidden_dim=latent_dim)
        ...
        for epoch in range(self.opt.n_epochs):
            ...
            print(f'Epoch [{epoch+1}/{self.opt.n_epochs}], Loss: {loss.item():.4f}')
    ...
    def test(self, data, label):
        ...
        criterion = nn.MSELoss()
        RMSEs = np.zeros(mae_output.shape[0])
