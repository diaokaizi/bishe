...
class MAEGAN:
    ...
    def __init__(self, opt, input_dim, maxAE=10, minAE=10, feature_map=None, batch_size=64, filepath="result"):
        ...
        self.clf = model_class(**model_configs, random_state=42, device="cpu")
